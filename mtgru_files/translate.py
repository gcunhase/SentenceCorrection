...
tf.app.flags.DEFINE_string("test_file_out", "newstest2013_1000_out_mtgru.txt",
	"File with the decoding of the test file (output from Model).") #newstest2013_small_out_mtgru.txt
